function OutAccuracy = AD_svm(ROIBeta,method)
...
addpath '/data2/2020_ActDecode_Cueing/analysis/Scripts/Misc/'
switch method
    case 'avgRun'
...
for i=1:nRun
    ...
    OutAccuracy(i) =sum(strcmp(labels1, ytest))/size(labels1,1);
